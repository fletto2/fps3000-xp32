...
_NOTE_PAIRS = [
 ...
 (0xF083FC,'16 x 4-byte CHANNEL DISPATCH TABLE, twin of RDHC\'s $F05102. Sixteen codes'),
 (0xF08400,'  onto three handlers: idx 2-7,13-15 -> $F0810A; idx 8,9 -> $F08366;'),
 (0xF08404,'  idx 1,10 -> $F0826A (never yet reached); idx 0,11,12 are rts, no handler.'),
 (0xF0810A,'channel dispatch handler A -- 9 of the 16 codes land here.'),
 (0xF08366,'channel dispatch handler B -- codes 8 and 9.'),
 (0xF0826A,'channel dispatch handler C -- codes 1 and 10; NOT yet executed.'),
