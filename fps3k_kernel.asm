...
loc_F00A1A:
  f00a1a: 4e 73                    rte      
  f00a1c: 4a b8 0c 78              tst.l    $c78.w
  f00a20: 66 10                    bne.b    $f00a32
  f00a22: 00 7c 70 00              ori.w    #$7000, sr
  f00a26: 48 e7 ff fe              movem.l  d0-d7/a0-a6, -(a7)
  f00a2a: 21 cf 0c 78              move.l   a7, $c78.w
  f00a2e: 46 ef 00 3c              move.w   $3c(a7), sr
