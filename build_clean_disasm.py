...
FUNCTIONS = [
    (0xF04488, 0xF046E0, 'task__init_misc'),       # pre-RDHC fragment
    (0xF046E0, 0xF046F0, 'ChannelConfigOffsetTable'),  # 4 longwords: 0x244,0x246,0x250,0x252 (XLTR_CH{1..4}_CONFIG offsets) — MC pass 2 finding
    ...
    (0xF08DF8, 0xF08EAC, 'BoardStatusPoll_3F11'),
